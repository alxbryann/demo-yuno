...
import { type Locale, enUS as localeEnUS } from "date-fns/locale";
  ...
  (
    ...
    const formateSelectedDate = React.useCallback(
      (date: Date | undefined, selectedDate: Date) => {
        const parsedDateTime = parseDateTime(selectedDate, locale as Locale);
...
const DateTimeLocalInput = ({
  ...
  const formateSelectedDate = React.useCallback(
    (date: Date | undefined, selectedDate: Date, e: React.MouseEvent) => {
