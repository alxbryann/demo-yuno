...
El Form Builder incluye una amplia variedad de tipos de campos para cubrir todas las necesidades de entrada de datos.

## Campos de texto

### Input

Campo de texto básico para entrada de texto corto.
