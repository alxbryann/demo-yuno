...
Yuno Demo incluye un sistema completo de temas con soporte para modo oscuro y múltiples esquemas de color.

## Sistema de temas

El sistema de temas está basado en **CSS Variables** y **Tailwind CSS**, permitiendo personalización completa y dinámica.

## Temas disponibles

Los siguientes temas están incluidos por defecto:
...
- 🔴 **Red** - Rojo vibrante
- 🟡 **Yellow** - Amarillo cálido
- 🟠 **Orange** - Naranja energético

## Usar el selector de temas
